    ...
    return (
        <footer>
            <div className="footer-brand">
                ...
                <span className="footer-name">Preston Sparks</span>
            </div>

            <p className="footer-disclaimer">
                This page/site is for a semester project in IMED 1341. Preston Sparks - May 09, 2026
            </p>
